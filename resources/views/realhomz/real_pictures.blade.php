<div class="realPictures" style="position: relative;">
	<div class="card real_pics" style="height: 300px; margin-bottom: 20px; background-color: {{$real->color()}}; background-image: url({{$home_url . $real->image()}}); background-position: center; background-size: cover"></div>
	@if($my_home)
