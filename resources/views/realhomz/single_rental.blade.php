				...
				<div class="card">
					<div class="hidden visible-xs">
						@if($real->images->count() > 0)
							<div style="height: 300px; margin-bottom: 20px; background-color: {{$real->color()}}; background-image: url({{$rental_url . $real->images->first()->image_url}}); background-position: center; background-size: cover"></div>
						@else
							<div style="height: 300px; margin-bottom: 20px; background-color: {{$real->color()}}; background-image: url({{$rental_url . $real->image()}}); background-position: center; background-size: cover"></div>
						@endif
					</div>
...
<?php
	...
	$add_pictures_url = "/addPicturesToRental";
?>
